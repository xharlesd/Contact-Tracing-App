...
class Search():
    ...
    def __init__(self):
        ...
        self.contact_person = tk.Label(self.window, text="RESPONDENT", fg = "#002244", bg = "#F5F5F5", font=("Franklin Gothic Demi",14))
        ...
        self.contact_person = tk.Label(self.window, text="HEALTH DECLARATION", fg = "#002244", bg = "#F2F3F5", font=("Franklin Gothic Demi",14))
        self.contact_person.place(x=370, y=515, width = 190, height = 35)
